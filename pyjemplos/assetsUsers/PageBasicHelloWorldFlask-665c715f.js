import{p as h}from"./posts-845a2cee.js";import{P as r}from"./prism-line-numbers-025586a8.js";import{d as p,j as _,a as u,c as f,h as e,t as i,u as o,f as a,b as l,w as c,e as v,p as g,g as k,i as y,r as x,s as b}from"./index-650011cb.js";import"./_commonjsHelpers-042e6b4d.js";const t=s=>(g("data-v-2fecd9f0"),s=s(),k(),s),w={class:"post-container"},E=["href"],j=v(`<h2 data-v-2fecd9f0>Descripción</h2><p data-v-2fecd9f0>La lista de archivos del repositorio es la siguiente</p><ul class="ml-12" data-v-2fecd9f0><li data-v-2fecd9f0><code data-v-2fecd9f0>.gitignore</code></li><li data-v-2fecd9f0><code data-v-2fecd9f0>LICENSE</code></li><li data-v-2fecd9f0><code data-v-2fecd9f0>README.md</code></li><li data-v-2fecd9f0><code data-v-2fecd9f0>hello.py</code></li><li data-v-2fecd9f0><code data-v-2fecd9f0>requeriments.txt</code></li></ul><p data-v-2fecd9f0> El archivo <code data-v-2fecd9f0>.gitignore</code> es usado par no almacenar en el repositorio la carpeta <code data-v-2fecd9f0>.flask_venv</code> que corresponde al ambiente virtual y la carpeta <code data-v-2fecd9f0>__pycache__</code> que se genera al ejecutar el programa, ambas carptas deben generarse en el ambiente de ejecución. </p><p data-v-2fecd9f0> El archivo <code data-v-2fecd9f0>LICENSE</code> solo contiene la espeficicación de la licencia. </p><p data-v-2fecd9f0> En el archivo <code data-v-2fecd9f0>README.md</code> se encuentran las instrucciones para instalar las dependencias y ejecutar la aplicaión. </p><p data-v-2fecd9f0><code data-v-2fecd9f0>hello.py</code> corresponde al archivo principal, el cual debe ejecutarse con el comando <pre data-v-2fecd9f0>                <code data-v-2fecd9f0>
            ...
            </pre> con el ambiente virtual activado, se instalarán todas las dependencias necesarias. </p><h3 data-v-2fecd9f0> hello.py </h3><p data-v-2fecd9f0> La aplicación inicia con la importación del módulo y la creación de una instancia la cual se inicializa con el parametro <code data-v-2fecd9f0>__name__</code> que hace referencia al nombre del archivo. </p>`,10),q=t(()=>e("p",null," Esta aplicación consta de 2 rutas determinadas por los decoradores ",-1)),H=t(()=>e("p",null," y cuyas url correspondientes son ",-1)),F=t(()=>e("p",null,"Al visitar la primer url se visualizará un resultado similar al siguiente",-1)),I=t(()=>e("div",{class:"url1"}," Hola mundo!!! ",-1)),P=t(()=>e("p",null," y para la segunda url un resultado similar a este ",-1)),B=t(()=>e("div",{class:"url2"}," Hola mundo desde un template ",-1)),C=t(()=>e("p",null," La única diferencia entre estas vistas, es que en la segunda se retorna un string con formato de template html para poder incluir estilos, hacer esto no es recomendable, ya que si se desea renderizar templates de sitios web con flask, es más eficiente usar algun motor de plantillas, en el caso de flask se usa jinja por defecto. ",-1)),S=t(()=>e("p",null," La parte central en el código corresponde al string que juega el papel de template ",-1)),L=t(()=>e("p",null," el cual retorna la segunda función, pero debemos de notar que amabas funciones retornan un string. Esto no siempre es así, ya que la mayoria de las veces se retornará alguna respuesta http ya que es una mejor manera para renderizar templates o crear APIs. ",-1)),z=t(()=>e("p",null,[a(" Para seguir practicando con este framework, la mejor opción es tomar un curso especializado y complementarlo con la documentación oficial "),e("a",{target:"_blank",href:"https://flask.palletsprojects.com/en/2.3.x/",class:"link-example"},"https://flask.palletsprojects.com/en/2.3.x/")],-1)),D=["href"],N=p({__name:"BasicHelloWorldFlask",setup(s){const n=_(h).value.filter(d=>d.id===3)[0];return(d,R)=>(u(),f("div",w,[e("h1",null,i(o(n).name),1),e("p",null,i(o(n).description),1),e("p",null,[a("Puedes consultar el repositorio del ejemplo "),e("a",{class:"link-example cursor-pointer font-semibold",href:o(n).repo},"en este enlace.",8,E)]),j,e("pre",null,[a("            "),l(o(r),{language:"python"},{default:c(()=>[a(`
    ...
    @app.route('/template')
            `)]),_:1}),a(`
        `)]),H,e("pre",null,[a("            "),l(o(r),{language:"python"},{default:c(()=>[a(`
    https://localhost:5000
    https://localhost:5000/template
            `)]),_:1}),a(`
        `)]),F,I,P,B,C,S,e("pre",null,[a("            "),l(o(r),{language:"python"},{default:c(()=>[a(`
    template = '''
    <!DOCTYPE htm>
    <html lang="en">
    <head>
    ...
    '''
            `)]),_:1}),a(`
        `)]),L,z,e("a",{target:"_blank",class:"link-example block text-center text-4xl font-bold my-16",href:o(n).repo},"REPOSITORIO",8,D)]))}});const T=y(N,[["__scopeId","data-v-2fecd9f0"]]),W={class:"page-container"},O=e("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"})],-1),U=p({__name:"PageBasicHelloWorldFlask",setup(s){return(m,n)=>{const d=x("router-link");return u(),f("div",W,[l(d,{class:"link-example text-2xl flex",to:`${o(b)}examples`},{default:c(()=>[O,a("   Regresar ")]),_:1},8,["to"]),l(T)])}}});export{U as default};
