import{p as f}from"./posts-845a2cee.js";import{P as c}from"./prism-line-numbers-025586a8.js";import{d as p,j as h,a as u,c as m,h as e,t as d,u as o,f as a,b as l,w as r,e as b,p as g,g as v,i as y,r as x,s as E}from"./index-650011cb.js";import"./_commonjsHelpers-042e6b4d.js";const i=s=>(g("data-v-bc31f306"),s=s(),v(),s),j={class:"post-container"},k=["href"],w=b('<h2 data-v-bc31f306>Descripción</h2><p data-v-bc31f306>El repositorio de este ejemplo consta de 3 archivos, los cuales son</p><ul class="ml-12" data-v-bc31f306><li data-v-bc31f306><code data-v-bc31f306>main.py</code></li><li data-v-bc31f306><code data-v-bc31f306>README.md</code></li><li data-v-bc31f306><code data-v-bc31f306>LICENSE</code></li></ul><p data-v-bc31f306> El archivo principal <code data-v-bc31f306>main.py</code> contiene el programa, los archivos <code data-v-bc31f306>README.md</code> y <code data-v-bc31f306>LICENSE</code> contienen las instrucciones para ejecutar el programa y la espeficicación de la licencia de código, respectivamente. </p><p data-v-bc31f306> El contenido del archivo <code data-v-bc31f306>main.py</code> se presenta a continuación </p>',5),H=i(()=>e("p",null,[a(" el programa consta de dos partes, la definición de una función "),e("code",null,"run()"),a(" y la ejecución de esta dentro del punto de entrada. En la función "),e("code",null,"run()"),a(" se hacen dos llamadas a la función "),e("code",null,"print()"),a(" cuyo resultado será la impresión en pantalla de las frases "),e("code",null,"Hola mundo!"),a(" y "),e("code",null,"Hello world!"),a(". Esto es un poco diferente al clásico programa de hola mundo, pero se hace de esta manera para ejemplificar las dos formas principales de escribir un dato de tipo string, usando comillas dobles y simples respectivamente. El hola mundo más simple posible en python se escribe de la siguiente manera ")],-1)),S=i(()=>e("p",null,"o siguiendo la misma linea de usar un punto de entrada, el programa se vería como",-1)),q=i(()=>e("p",null," La recomendación para este ejemplo es modificar el código fuente tratando de seguir las buenas prácticas, como por ejemplo, usar un punto de entrada para ejecutar el programa. ",-1)),B=["href"],I=p({__name:"BasicHelloWorld",setup(s){const n=h(f).value.filter(t=>t.id===1)[0];return(t,N)=>(u(),m("div",j,[e("h1",null,d(o(n).name),1),e("p",null,d(o(n).description),1),e("p",null,[a("Puedes consultar el repositorio del ejemplo "),e("a",{class:"link-example cursor-pointer font-semibold",href:o(n).repo},"en este enlace.",8,k)]),w,e("pre",null,[a("            "),l(o(c),{language:"python"},{default:r(()=>[a(`
    ...
    print("Hola mundo")
            `)]),_:1}),a(`
        `)]),S,e("pre",null,[a("            "),l(o(c),{language:"python"},{default:r(()=>[a(`
    def main():
        print("Hola mundo")
    ...
    if __name__ == '__main__':
        run()
            `)]),_:1}),a(`
        `)]),q,e("a",{target:"_blank",class:"link-example block text-center text-4xl font-bold my-16",href:o(n).repo},"REPOSITORIO",8,B)]))}});const P=y(I,[["__scopeId","data-v-bc31f306"]]),C={class:"page-container"},L=e("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor",class:"w-6 h-6"},[e("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"})],-1),W=p({__name:"PageBasicHelloWorld",setup(s){return(_,n)=>{const t=x("router-link");return u(),m("div",C,[l(t,{class:"link-example text-2xl flex",to:`${o(E)}examples`},{default:r(()=>[L,a("   Regresar ")]),_:1},8,["to"]),l(P)])}}});export{W as default};
